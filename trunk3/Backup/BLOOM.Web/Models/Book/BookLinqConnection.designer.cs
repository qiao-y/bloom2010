...
namespace BLOOM.Web.Models.Book
{
    ...
    partial void OnSnapshotChanged();
		...
		[Column(Storage="_ISBN", DbType="NChar(30)")]
		public string ISBN
		{
			get
			{
    ...
    partial void OnBooksViewedIdChanging(int value);
    partial void OnBooksViewedIdChanged();
    #endregion
		...
		[Column(Storage="_BooksViewedId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int BooksViewedId
		{
			get
			{
				return this._BooksViewedId;
			}
			set
			{
				if ((this._BooksViewedId != value))
				{
					this.OnBooksViewedIdChanging(value);
					this.SendPropertyChanging();
					this._BooksViewedId = value;
					this.SendPropertyChanged("BooksViewedId");
					this.OnBooksViewedIdChanged();
				}
			}
		}
